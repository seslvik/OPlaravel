...
$factory->define(Polygon::class, function (Faker $faker) {
    return [
            ...
            'pos_x_1'       => $faker->randomFloat(3, 0.2, 0.8),
            'pos_y_1'       => $faker->randomFloat(3, 0.2, 0.8),
            'pos_x_2'       => $faker->randomFloat(3, 0.2, 0.8),
            'pos_y_2'       => $faker->randomFloat(3, 0.2, 0.8),
            'pos_x_3'       => $faker->randomFloat(3, 0.2, 0.8),
            'pos_y_3'       => $faker->randomFloat(3, 0.2, 0.8),
            'pos_x_4'       => $faker->randomFloat(3, 0.2, 0.8),
            'pos_y_4'       => $faker->randomFloat(3, 0.2, 0.8),
