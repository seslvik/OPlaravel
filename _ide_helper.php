...
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Gidrant[]|Gidrant create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Gidrant[]|Gidrant make($attributes = [])
    */
    class GidrantsFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Operplan[]|Operplan create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Operplan[]|Operplan make($attributes = [])
    */
