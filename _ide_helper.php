 ...
 * Generated for Laravel 6.18.23 on 2020-07-08 16:49:43.
 *
...
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Gidrants[]|Gidrants create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Gidrants[]|Gidrants make($attributes = [])
    */
    class GidrantsFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Operplans[]|Operplans create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Operplans[]|Operplans make($attributes = [])
    */
    class OperplansFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
